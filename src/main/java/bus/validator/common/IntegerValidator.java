...
public class IntegerValidator extends BaseRangeValidator<Integer> {
    ...
    public IntegerValidator(Integer minValue, Integer maxValue) {
        super(minValue, maxValue, Integer.class);
    }

    public IntegerValidator(String displayName, Integer minValue, Integer maxValue) {
        super(displayName, minValue, maxValue, Integer.class);
    }

    @Override
    public ValidationResult convert(Object convertingValue, ObjectWrapper<Integer> convertedValue) {
        Integer result;
