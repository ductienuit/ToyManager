...
public class BigDecimalValidator extends BaseRangeValidator<BigDecimal> {
    public BigDecimalValidator() {
        this(BigDecimal.valueOf(Double.MIN_VALUE),
             BigDecimal.valueOf(Double.MAX_VALUE));
    }

    public BigDecimalValidator(BigDecimal minValue,
                               BigDecimal maxValue) {
        super(minValue,
              maxValue,
              BigDecimal.class);
    ...
    public BigDecimalValidator(String displayName,
                               BigDecimal minValue,
                               BigDecimal maxValue) {
        super(displayName,
              minValue,
    ...
    public ValidationResult convert(Object convertingValue,
                                    ObjectWrapper<BigDecimal> convertedValue) {
        BigDecimal result;
