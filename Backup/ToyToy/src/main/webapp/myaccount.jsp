...
<%@page import="com.toytoy.model.BillDetail"%>
<%@page import="com.toytoy.get.BillDetailGet"%>
<%@page import="com.toytoy.get.ProductGet"%>
<%@page import="java.text.DecimalFormat"%>
<%@page import="com.toytoy.get.UserGet"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.toytoy.get.BillGet"%>
<%@page import="com.toytoy.model.Bill"%>
...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
    ...
    <body>
        <%
            ...
            if (users == null) {
                response.sendRedirect("/ToyToy/login.jsp");
            }
	...
	<div class="container">
      ...
      <ul class="nav nav-pills" role="tablist">
        ...
        <li role="presentation"><a href="/ToyToy/LogoutServlet"><i class="glyphicon glyphicon-log-out" ></i><Đăng Xuất</a></li>
      </ul>
      </div>
        <!--//nav-->
