...
<%@page import="com.toytoy.model.Product"%>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <div id="rightContent">
                    ...
                    <a href="/ToyToy/admin/insert_product.jsp">Thêm sản phẩm</a>
                    <table class="data">
                        <tr class="data">
                    ...
                    <tr class="data">
                        ...
                        <td class="data"><img class="hinhql" src="/ToyToy/<%=product.getProductImage()%>"/></td>
                    ...
                    <center>
                        ...
                        <a href="/ToyToy/ManagerProductServlet?command=delete&product_id=<%=product.getProductID()%>">Xóa</a>
                    </center>
                    </td>
                    </tr>
                    <% }%>
