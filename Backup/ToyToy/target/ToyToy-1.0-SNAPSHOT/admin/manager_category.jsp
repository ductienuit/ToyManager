...
<div id="wrapper">
    ...
    <div id="rightContent">
        ...
        <a href="/ToyToy/admin/insert_category.jsp">Thêm danh mục</a>
        <table class="data">
            <tr class="data">
            ...
            <tr class="data">
                ...
                <td class="data"><%=category.getCategoryID()%>
                </td>
                ...
                <td class="data" width="90px">
                    <center>
                        ...
                        | &nbsp;&nbsp;
                        <a href="/ToyToy/ManagerCategoryServlet?command=delete&category_id=<%=category.getCategoryID()%>">Xóa</a>
                    </center>
                </td>
            </tr>
            <% } %>
