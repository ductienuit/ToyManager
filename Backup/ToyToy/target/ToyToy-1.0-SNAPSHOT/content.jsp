        ...
        <div class="col-md-6 col-m1 animated wow fadeInLeft" data-wow-delay=".1s">
            <div class="col-1">
                ...
                <div class="col-md-6 col-p">
                    <h5>GUITAR SHOP</h5>
                    <p>Chúng tôi có rất nhiều những sản phẩm nổi tiếng từ các hãng lớn như Taylor, Fender, Yamaha,
                        Gibson...</p>
            ...
            <div class="col-1">
                <div class="col-md-6 col-p">
                    <h5>PIANO SHOP</h5>
                    <p>Chúng tôi có rất nhiều những sản phẩm nổi tiếng từ các hãng lớn như Roland, Casio, Yamaha,
                        Samick...</p>
        ...
        <div class="col-sm-4 item-grid simpleCart_shelfItem">
            <div class="grid-pro">
                ...
                <div class="women">
                    ...
                    <h6><a href="single.jsp?productID=<%=p.getProductID()%>"><%=p.getProductName()%>
                    </a></h6>
